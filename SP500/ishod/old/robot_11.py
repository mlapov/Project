    ...
    def run(self):
        ...
        while True:
            ...
            if self.mainwindow.flag_connect:
                ...
                if (not flag_correct_config) or (not flag_correct_calendar):  # если конфиг или календарь не корректен - выходим
                ...
                while self.isConnected() or not self.msg_queue.empty():
                    ...
                    if time_paper:  # контракт читали и время бумаги уже не None
                        ...
                        if not self.flag_Position:
                            if time_paper.hour == self.time_to_act['input_hour'] and time_paper.minute == self.time_to_act['input_min'] and time_paper.second >= self.time_to_act['input_sec']:
            ...
            # мы разъединены c сервером
                ...
                a = a + 1
                print('a = ', a)
                print(self.mainwindow.flag_connect, ' ', self.mainwindow.flag_change_config1) #flag_flag_connect_old)
                time.sleep(0.5)
