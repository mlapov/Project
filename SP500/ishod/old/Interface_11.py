...
class WinUser(Interface):
    def __init__(self):
        ...
        self.flag_change_config2 = 10 + self.flag_change_config1
    ...
    def initWinUser(self):
        ...
        self.lbl_working_time = QLabel('Working Time: ', self)
...
class WinService(Interface):
    ...
    def button_Save(self):
        ...
        self.flag_change_config1 = 2
        flag_change_config1 = 2
