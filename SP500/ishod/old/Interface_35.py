    ...
    def run(self):
        while self.flag_run_email:
            ...
            if self.flag_sent_email:
                ...
                # self.host_email = "smtp-mail.outlook.com: 587"
                # self.subject_email = "тест 12" #"Subscription" + str(self.i)
                # self.to_addr_email = "mikhaillapov12@gmail.com"
                # self.from_addr_email = "robot_sp@hotmail.com"
                # self.password_email = "Abyrvalg44!"
                # self.body_text_email = "тест 12" #+ str(self.i)
