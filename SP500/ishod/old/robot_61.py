 ...
 к выяснению и доработке
  ...
  можно синхронизировать текуе часы робота и серверные - пробовал - но это гемор
    ...
    ПОПРОБОВАНО - IB Gatey попробывать - работает не корректно, какие-то затупы
     ...
     - exe-шник сделать - https://pyinstaller.org/en/stable/index.html
     - другой комп, другую винду, Linux, V - сделать стандартные настроки
    ...
    - когда сделка завершается в Message  в лог пишется 2 раза - Сделка на 20 контракт(ов) завершена!
