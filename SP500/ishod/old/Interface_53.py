    ...
    def button_Save(self, event):
        ...
        if reply == QMessageBox.Yes:
            ...
            try:
                ...
                print(f"Risk (!) не число: {risk}")
                logging.critical(f"Risk (!) не число: {risk}")
                wU.lbl_Message_Edit.append(f"Risk не число: {risk}")
...
if __name__ == '__main__':
    ...
    rb.signal_textFoo.connect(wU.text_from_robot, Qt.QueuedConnection)
